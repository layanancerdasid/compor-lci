        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col mb-5 mt-10">
            <p className="text-lg text-justify">
              ...
              dari integrasi teknologi tersebut berupa teknologi end to end
              seperti berikut:
            </p>
            <img
            ...
            <p className="text-lg text-justify mt-5">
              ...
              dengan koneksi beragam yang digunakan dalam sistem IoT seperti
              LoRA, WiFi, GPRS, dan 4G/5G yang dapat menyesuaikan dengan
              kebutuhan di lapangan, juga dilengkapi dengan prosesor berbasis ARM
              serta packaging node yang kuat dan kokoh serta berstandar IP57 yang
              tahan akan kondisi cuaca di lapangan.
            </p>
            <img
            ...
            <p className="text-lg text-justify mt-5">
              ...
              maintenance. Dengan memonitor kondisi aset secara real-time,
              perusahaan dapat melihat kinerja perangkat dan memprediksi terjadinya
              kerusakan dengan akurat dan menghindari terjadinya malfungsi total.
            </p>
