    ...
    const kasus = [
        {
            ...
            desc:
                "Tempat sampah berbasis IoT dilengkapi dengan sensor dan koneksi internet ",
        },
        {
        ...
        },
        {
            ...
            desc:
                "Survey Kondisi Perkerasan Jalan merupakan kegiatan yang dituju untuk menilai fungsional jalan secara fisik",
        },
        {
            icon: "IoBoatSharp",
            title: "Smart Maritime",
            desc:
                "teknik pengolahan gambar untuk mengenali dan mengidentifikasi ikan di perairan",
        },
        {
            icon: "TbEaseInOutControlPoints",
            title: "Air Quality Monitoring",
            desc:
                "Sistem pemantauan kondisi kualitas udara untuk perlindungan lingkungan",
        },
        {
            icon: "GiPlantWatering",
            title: "Smart Watering System",
            desc:
                "Perangkat yang dirancang untuk mengelola irigasi di perkebunan. ",
        },
        {
            icon: "GiFertilizerBag",
            title: "Automatic Nutrition Dosing System",
            desc:
                "menjaga keseimbangan nutrisi dan pH dalam air yang mengalir di dalam sistem hidroponik,",
        },
    ];
        ...
        <>
            ...
            <section className="container mx-auto my-8 px-4">
                <p className="text-gray-700 leading-relaxed">
                    ...
                    perangkat IoT, mengurangi kompleksitas, memastikan efisiensi
                    perangkat, dan mendorong inovasi di seluruh industri yang
                    mencari peluang pertumbuhan dan efisiensi operasional.

                    Kini teknologi IoT telah dapat diaplikasikan ke berbagai
                    industri. Tidak hanya meningkatkan efisiensi operasional
                    suatu perusahaan, teknologi IoT juga berfungsi memberi
                    kemudahan dalam menjalankan bisnis dengan automasi,
                    manajemen aset bisnis, kontrol biaya, dan masih banyak lagi.
                    Berikut keseluruhan komponen dalam solusi IoT kami yang
                    saling berkaitan satu sama lain untuk meningkatkan efisiensi
                    operasional.
                </p>
            </section>
